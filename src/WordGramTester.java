...
public class WordGramTester {
	...
	public void testToString() {
		// fill in code
		String[] words1 = {"apple", "zebra", "mongoose", "hat", "cat"};
		String[] words2 = {"coding", "is", "super", "fun"};
		String[] words3 = {"Ill", "take", "LeBron", "over", "Jordan"};
		String[] words4 = {"i", "miss", "barack", "obama"};
		WordGram a = new WordGram(words1,0,4);
		WordGram b = new WordGram(words2,2,2);
		WordGram c = new WordGram(words3,2,3);
		WordGram d = new WordGram(words4,0,3);
		String w1 = a.toString();
		String w2 = b.toString();
		String w3 = c.toString();
		String w4 = d.toString();
		assertEquals("toString fails",w1.equals("apple zebra mongoose hat"),true);
		assertEquals("toString fails",w2.equals("super fun"),true);
		assertEquals("toString fails",w3.equals("Ill take LeBron"),false);
		assertEquals("toString fails",w4.equals("miss barack obama"),false);
	}
	
	@Test
	public void testShiftAdd() {
		// fill in code
		String[] words1 = {"i", "miss", "barack", "obama"};
		WordGram a = new WordGram(words1,0,3);
		WordGram a1 = new WordGram(words1,1,3);
		WordGram b = new WordGram(words1,0,2);
		WordGram b1 = new WordGram(words1,1,2);
		WordGram as = a.shiftAdd("obama");
		WordGram bs = b.shiftAdd("barack");
		String w1a = as.toString();
		String w2a = a1.toString();
		String w1b = bs.toString();
		String w2b = b1.toString();
		assertEquals("shift add",w1a.equals(w2a),true);
		assertEquals("shift add",w1b.equals(w2b),true);
		
		String[] words2 = {"Ill", "take", "LeBron", "over", "Jordan"};
		WordGram c = new WordGram(words2,1,3);
		WordGram c1 = new WordGram(words2,2,3);
		WordGram d = new WordGram(words2,0,2);
		WordGram d1 = new WordGram(words2,1,2);
		WordGram cs = c.shiftAdd("Jordan");
		WordGram ds = d.shiftAdd("LeBron");
		String w1c = cs.toString();
		String w2c = c1.toString();
		String w1d = ds.toString();
		String w2d = d1.toString();
		assertEquals("shift add",!w1c.equals(w2c),false);
		assertEquals("shift add",!w1d.equals(w2d),false);
